process BOWTIE2_ALIGN {
    ...
    bowtie2 \\
        ...
        | samtools $samtools_command -n --threads $task.cpus \\
        | samtools fixmate -m - - \\
        | samtools sort -l 0 --threads $task.cpus | samtools markdup -r -s - - \\
        | samtools view -b -F 12 --threads $task.cpus > ${prefix}.bp-mapped.bam 
